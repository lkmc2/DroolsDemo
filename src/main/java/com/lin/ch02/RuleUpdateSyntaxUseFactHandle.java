...
/**
 * update 相关规则语法的例子（使用FactHandle执行更新，此处存疑，代码执行不起来）
 * @author lkmc2
 * @date 2019/8/22 16:13
 */
public class RuleUpdateSyntaxUseFactHandle {

    public static void main(String[] args) {
        KnowledgeBuilder builder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        builder.add(ResourceFactory.newClassPathResource("ch02/RuleUpdateSyntaxUseFactHandle.drl", Demo.class), ResourceType.DRL);
