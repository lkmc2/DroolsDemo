...
/**
 * retract 相关规则语法的例子（删除对象）
 * @author lkmc2
 * @date 2019/8/22 16:13
 */
public class RuleRetractSyntax {

    public static void main(String[] args) {
        KnowledgeBuilder builder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        builder.add(ResourceFactory.newClassPathResource("ch02/RuleRetractSyntax.drl", Demo.class), ResourceType.DRL);
