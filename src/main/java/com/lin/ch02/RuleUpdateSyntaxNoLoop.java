...
/**
 * update 相关规则语法的例子（添加no-loop属性，让update的时候不再重新执行已执行过的规则）
 * @author lkmc2
 * @date 2019/8/22 16:13
 */
public class RuleUpdateSyntaxNoLoop {

    public static void main(String[] args) {
        KnowledgeBuilder builder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        builder.add(ResourceFactory.newClassPathResource("ch02/RuleUpdateSyntaxNoLoop.drl", Demo.class), ResourceType.DRL);
        ...
        /*
        运行结果：
        插入对象：Customer{name='王明', age=21, gender='null', city='null'}
        rule2: 王明
        Customer 对象个数：1
        end......
         */
